...
const THEME_STORAGE_KEY = "investcool-theme-reader-v5";
...
const PREVIOUS_READER_THEME_V3_STORAGE_KEY = "investcool-theme-reader-v3";
const PREVIOUS_READER_THEME_V4_STORAGE_KEY = "investcool-theme-reader-v4";
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (savedTheme === "light" || savedTheme === "dark") {
      ...
      localStorage.removeItem(PREVIOUS_READER_THEME_V3_STORAGE_KEY);
      localStorage.removeItem(PREVIOUS_READER_THEME_V4_STORAGE_KEY);
