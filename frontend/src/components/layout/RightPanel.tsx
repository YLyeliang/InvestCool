...
export const RightPanel = () => {
  return (
    <aside className="right-panel hidden xl:flex flex-col gap-6 w-[320px] shrink-0 sticky top-[var(--header-height)] h-[calc(100vh-var(--header-height))] p-6 overflow-y-auto border-l border-[var(--border-color)] bg-[var(--section-bg)]">
      ...
      <div className="card p-5 space-y-4">
        <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-3">
          ...
          <div className="size-1.5 rounded-full bg-[var(--danger-color)] animate-ping"></div>
        </div>
        <div className="space-y-4">
          {[
      ...
      {/* 简洁的小挂件 */}
      <div className="mt-auto p-4 rounded-lg bg-[var(--accent-soft)] border border-[var(--accent-color)]/20">
