  ...
  return (
    ...
    >
      <nav className="flex-1 px-4 py-6 space-y-7 overflow-y-auto no-scrollbar">
        {sections.map((section) => (
          <div key={section.label}>
            <h3 className="px-3 text-[11px] font-semibold uppercase text-[var(--text-tertiary)] mb-3">
              {section.label}
            </h3>
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-[var(--card-bg)] text-[var(--accent-strong)] font-semibold border border-[var(--border-strong)] shadow-sm"
      ...
      <div className="p-4 border-t border-[var(--border-color)] bg-[var(--section-bg)]">
        <h4 className="px-2 text-[11px] font-semibold text-[var(--text-tertiary)] uppercase mb-3">关注我</h4>
        <div className="grid grid-cols-2 gap-3">
          <div className="group/qr flex flex-col items-center gap-1.5">
            ...
            <span className="text-[10px] font-semibold text-[var(--text-secondary)]">公众号</span>
          </div>
          <div className="group/qr flex flex-col items-center gap-1.5">
            <div className="bg-[var(--card-bg)] p-1.5 rounded-lg border border-[var(--border-color)] shadow-sm">
              <img src="/images/qrcodes/qr2.jpg" className="size-16 object-cover rounded-md" alt="小红书" />
            </div>
            <span className="text-[10px] font-semibold text-[var(--text-secondary)]">小红书</span>
          </div>
        </div>
      </div>
    </aside>
